    ...
    for (;;)
    {
        ...
        if (rc > 0)
        {
            ...
            */
            ...
            // EN ESTA SECCION SE DEBEN ENVIAR LOS DOS NUEVOS VALORES DE A Y B, LOS CLIENTES QUE ESCUCHAN SE CONECTAN DE LA MISMO FORMA, LA UNICA DIF ES QUE EL RECUENTO SOLO ENVIA INFORMACION, Y LOS VISUALIZADORES ESCUCHAN SOLAMENTE
